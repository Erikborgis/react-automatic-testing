    ...
    for file_name, path in react_files_and_paths:
        ...
        if react_component_text:
            ...
            for temperature_iteration in range(steps_temperature):
                ...
                test_content = write_to_gpt.call_openai_api(gpt_message, temperature)
                ...
                if test_status:
                  ...
                  for number_of_tries in range(2, max_number_of_tries + 1):
                    ...
                    test_content = write_to_gpt.regenerate_test(gpt_message, temperature)
                ...
                csv_operations.append_to_csv_files(file_name, number_of_tries, test_status, temperature, coverage, test_file_name) 
